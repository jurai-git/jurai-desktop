...
import com.jurai.ui.controls.BooleanReactiveLabel;
import com.jurai.ui.controls.SimpleList;
import com.jurai.ui.controls.fluent.SplitGroup;
...
public class DocumentChooser extends AbstractMenu<HBox> {
    ...
    public SimpleList<Demanda> getDocList() {
        return this.docList;
    }
    ...
    public Ref<FButton> getSendButtonRef() {
        return this.sendButtonRef;
    }
}
