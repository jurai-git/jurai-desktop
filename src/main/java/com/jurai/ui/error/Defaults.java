...
public class Defaults {
    public static final String DEFAULT_400 = "Parece que seu cliente do JurAI está desatualizado. Atualize-o e tente novamente.";
    public static final String DEFAULT_401 = "Ocorreu um erro com sua autenticação. Tente sair e entrar novamente.";
    public static final String DEFAULT_500 = "Ocorreu um erro interno no nosso servidor. Tente novamente mais tarde.";
    ...
    public static final String DEFAULT_600 = "Ocorreu um erro de rede! Verifique sua conexão com a internet e tente novamente.";
